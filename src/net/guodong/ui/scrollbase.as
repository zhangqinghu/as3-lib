package net.guodong.ui
{
	 ...
	 * 
	 */	
	public class scrollbase extends MovieClip
	{
		...
		public function scrollbase(content:MovieClip, contMask:MovieClip, dragger:MovieClip, scrollbar:MovieClip, speed:uint = 2, scalable:Boolean = false, padding:uint = 0):void
		{
			_content 			= content;
			_contMask			= contMask;
			_dragger 			= dragger;
		...
		*/
		...
		public function verifyHeight():void
		{
			...
			else
			{
				...
				if ( _scalable ) _dragger.height = ((_contMask.height / _content.height) * _scrollbar.height);
			}
		}
